...
class TabBar extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "getComputedContentContainerSpacing", style => {
      const contentStyle = _reactNative.StyleSheet.flatten(style);

      let space = 0;

      if (typeof (contentStyle === null || contentStyle === void 0 ? void 0 : contentStyle.marginHorizontal) === 'number') {
        space += contentStyle.marginHorizontal * 2;
      }

      if (typeof (contentStyle === null || contentStyle === void 0 ? void 0 : contentStyle.marginLeft) === 'number') {
        space += contentStyle.marginLeft;
      }

      if (typeof (contentStyle === null || contentStyle === void 0 ? void 0 : contentStyle.marginRight) === 'number') {
        space += contentStyle.marginRight;
      }

      if (typeof (contentStyle === null || contentStyle === void 0 ? void 0 : contentStyle.paddingHorizontal) === 'number') {
        space += contentStyle.paddingHorizontal * 2;
      }

      if (typeof (contentStyle === null || contentStyle === void 0 ? void 0 : contentStyle.paddingLeft) === 'number') {
        space += contentStyle.paddingLeft;
      }

      if (typeof (contentStyle === null || contentStyle === void 0 ? void 0 : contentStyle.paddingRight) === 'number') {
    ...
    _defineProperty(this, "getTabBarWidth", (props, state) => {
      ...
      return routes.reduce((acc, _, i) => acc + this.getComputedTabWidth(i, layout, routes, scrollEnabled, tabWidths, this.getFlattenedTabWidth(tabStyle)), this.getComputedContentContainerSpacing(contentContainerStyle));
    });
